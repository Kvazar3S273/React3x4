    ...
    <div className="row mt-3 mb-3">
      <div className="col py-3">
        ...
        <p className="mx-5">
          ...
          декілька видів ламінування, різні види пружинки.<br/>
          Розрахунок ціни на друк блокнотів проводиться після запиту. 
          Для узгодження ціни потрібно обговорити параметри блокнота і 
          тоді ми розрахуємо для Вас вартість виготовлення даної продукції.
        </p>
      </div>
    </div>
  );
