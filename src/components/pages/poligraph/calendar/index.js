      ...
      <div className="col py-3" style={{ backgroundColor: "#e0e3e5" }}>
        ...
        <div className="row m-3 p-2">
          ...
          <div className="col-md-10 px-3">
            <p>
            Кишеньковий календарик має невеликі розміри (10х7 см), але, 
            не дивлячись на це, він надає величезне поле діяльності для 
            ...
            в сувеніри-подарунки для партнерів. На них можна розміщувати як
             загальні рекламні відомості, так і конкретні контакти. 
             Великий плюс цих календарів – їх невеликий розмір, що дозволяє 
             носити їх в гаманці, кишені тощо та актуальність на протязі всього року!<br/>
            ...
            <p>
            <b>Вимоги до розмірів макету:</b> 104х74 мм.<br/>
        ...
        <div className="row">
          ...
          <p className="text-center">
            ...
            (формат - 70х100 мм, тираж - 1000 екз., термін - 7 роб. днів)
            </p>
          {/* Таблиця 1 */}
          <div className="col">
            <div className="row">
