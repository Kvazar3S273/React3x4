  ...
  return (
    <div className="row mt-3 mb-3">
      <div className="col py-3">
        ...
        <p className="mx-5">
          Для кожного виду календарів є великий перелік опцій, таких як: формат,
          тип паперу для обкладинки, внутрішнього блоку, підложки, розміри
          рекламного поля, декілька видів ламінування, різні види пружинки.
        </p>
        <p className="mx-5">
