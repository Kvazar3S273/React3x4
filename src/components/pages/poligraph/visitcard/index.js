      ...
      <div className="col py-3" style={{ backgroundColor: "#e0e3e5" }}>
        ...
        <div className="row m-3 p-2">
          ...
          <div className="col-md-10 px-3">
            <p>
            Дуже важливою частиною ділового спілкування є візитка. 
            Перш ніж замовити візитки, потрібно чітко усвідомити, 
            з якою ціллю Ви плануєте друк візиток, як ваша візитка 
            повинна виглядати і яку інформацію містити.
            </p>
            <p>
            Візитки можуть бути стандартного формату <b>(90х50 мм)</b> або 
            Євроформату <b>(85х55 мм)</b> з одно- або двостороннім друком. 
            Євровізитка має свої плюси. По-перше, всі візитниці розраховані 
            на картки таких розмірів, по-друге більшість портмоне мають 
            відділи для кредиток. Якщо ваша кредитка буде зроблена у вигляді 
            ...
            <p>
            Ми друкуємо візитки на крейдованому папері різної щільності – 
            від <b>250 г/м.кв.</b>, до <b>450 г/м.кв.</b> з глянцевим, матовим, ультрафіолетовим 
            (повним або вибірковим) покриттям або без нього.
            </p>
            <p>
