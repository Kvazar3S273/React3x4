      ...
      <div className="col py-3" style={{ backgroundColor: "#e0e3e5" }}>
        ...
        <div className="row">
          ...
          <p className="text-center">
            ...
            - 1000 екз., термін - 7 роб. днів)<br/>
            На останні три позиції - для паперу 350 г/м.кв. з одностороннім глянцевим покриттям,
            для різних тиражів, термін виконання - 5 роб. днів.
          </p>
          {/* Таблиця 1 */}
          <div className="col">
            <div className="row">
