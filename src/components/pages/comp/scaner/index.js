        ...
        <div className="col py-3" style={{ backgroundColor: "#e0e3e5" }}>
          ...
          <div className="row m-3 p-2">
            ...
            <div className="col-md-8 px-3">
              <p>
                Сканування документів до А4 розміру та збереження в форматах
                *.jpg або *.pdf.
              </p>
              <p>
                Додаткова послуга: відправка ваших сканованих документів на
                електронну пошту. Один лист вміщує до 18 Мб інформації. Якщо
                об'єм сканованих документів перевищує 18 Мб, то він розбивається
                на декілька листів.
              </p>
