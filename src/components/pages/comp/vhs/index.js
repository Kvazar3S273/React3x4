      ...
      <div className="col py-3" style={{ backgroundColor: "#e0e3e5" }}>
        ...
        <div className="row m-3 p-2">
          ...
          <p>Оцифровка відеокасет дає можливість перенести старі відеозаписи пам'ятних
			...
			Ми оцифровуємо відеокасети в MPEG-формат та записуємо відео на флешку. Відео не оброблюємо,
			а віддаємо лише точну копію Вашої касети.<br/> Переписуємо касети VHS та miniDV.<br/>
            Мінімальна вартість роботи - ціна перезапису одної години відео, навіть при умові, 
