          ...
          <div className="row">
            ...
            <div className="col-md-8">
              <img
                ...
                src="/images/services/comp/xerox.jpg"
                alt="Копії"
              />
            </div>
            <div className="col-md-2"></div>
          ...
          <div className="row m-3 p-2">
            ...
            <div className="col-md-10 px-3">
              <p>
                ...
                наявності для друку завжди є звичайний офісний папір (80
                г/м.кв.), цупкий папір (190 г/м.кв.), фотопапір (від 110 до 220
                г/м.кв.), а також кольоровий папір та кольоровий картон.
                Чорно-білий друк здійснюється лазерними принтерами, кольоровий -
                струменевими в режимі фотоякості.
              </p>
            </div>
            <div className="col-md-1"></div>
          </div>
          ...
          <div className="container mb-4">
            ...
            <div className="row ">
              <div className="col-md-3 col-sm-6 text-center">
                <h3>
                  <span
                    className="badge m-3 p-5"
                    style={{ background: "#5586B0" }}
                  >
                    ВСІХ <br />
                    КОМПАКТ
                    <br /> ДИСКІВ
                ...
                <div className="col-7 col-sm-5 col-md-3 col-lg-2 m-2 p-2 border bg-light rounded ">
                  <div className="card">
                    ...
                    <div className="card-body">
                      <h5 className="card-title text-center">Текст</h5>
                      <p className="card-text">
                        Звичайний текст невеликого розміру шрифтів без будь-яких
                        малюнків
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-7 col-sm-5 col-md-3 col-lg-2 m-2 p-2 border bg-light rounded ">
                  <div className="card">
                    ...
                    <div className="card-body">
                      ...
                      <p className="card-text">
                        Присутній текст і малюнки, які займають не більше 25%
                        площі сторінки
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-7 col-sm-5 col-md-3 col-lg-2 m-2 p-2 border bg-light rounded ">
                  <div className="card">
                    ...
                    <div className="card-body">
                      ...
                      <p className="card-text">
                        Малюнки, що є в тексті, в сукупності займають не більше
                        50% площі
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-7 col-sm-5 col-md-3 col-lg-2 m-2 p-2 border bg-light rounded ">
                  <div className="card">
                    ...
                    <div className="card-body">
                      ...
                      <p className="card-text">
                        Документ містить 1 або більше малюнків, які заповнюють
                        весь аркуш
                      </p>
                    </div>
                  </div>
