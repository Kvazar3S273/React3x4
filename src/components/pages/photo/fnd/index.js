              ...
              <div className="row gx-5 p-4 justify-content-center">
                ...
                <div className="col-md-4">
                  <div className="row">
                    ...
                    <div className="col-md-9 col-9">
                      <h4>Більше</h4>
                      <p>Кожне наступне фото: +20 грн</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-md-4">
                  <div className="row">
                    ...
                    <div className="col-md-9 col-9">
                      <h4>Швидко</h4>
                      <p>Термінове фото: +50 грн за 7-10 хв</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-md-4">
                  <div className="row">
                    ...
                    <div className="col-md-9 col-9">
                      <h4>Костюм</h4>
                      <p>Заміна одягу: +70 грн, вибір з каталога</p>
                    </div>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="row">
                    ...
                    <div className="col-md-9 col-9">
                      <h4>Без друку</h4>
                      <p>
                        Тільки фотографування, скидання на флешку -30 грн від
                        ціни
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-md-4">
                  <div className="row">
                    ...
                    <div className="col-md-9 col-9">
                      <h4>Оригінал</h4>
                      <p>Скидання фото з архіва на носій 50 грн</p>
                    </div>
                  </div>
                </div>
              </div>
