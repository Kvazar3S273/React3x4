          ...
          <div className="row m-3 p-2">
            ...
            <div className="col-md-8 px-3">
              <p>
                ...
                ультрафіолету, вологості, механічних пошкоджень чи інших
                чинників. У таких випадках на допомогу приходить реставрація.
                Відновлення старої фотографії трудоємкий і цікавий процес,
                винагородою якого завжди є результат. Ви будете вражені як
                "помолодшає" ваша фотокартка, особливо, якщо вона була у вкрай
                тяжкому стані.
              </p>
              <p>
