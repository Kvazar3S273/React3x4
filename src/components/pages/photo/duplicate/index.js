          ...
          <div className="row m-3 p-2">
            ...
            <div className="col-md-8 px-3">
              <p>
                ...
                дадуть Вам змогу зробити це. При дублюванні фотографій,
                звичайно, якість їх дещо відрізнятиметься, але, з іншого боку, в
                деяких випадках це дає змогу зробити знімки навіть гарнішими,
                застосувавши корекції кольору та чіткості.
              </p>
