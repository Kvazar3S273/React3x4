        ...
        <div className="col py-3" style={{ backgroundColor: "#e0e3e5" }}>
          ...
          <div className="row m-3 p-2">
            ...
            <div className="col-sm-12 col-md-5 px-3">
              ...
              <p>
                Фотокнига printbook — це надрукована на сучасному цифровому
                обладнанні поліграфічним способом книга. Внутрішні листи
                надруковані на 170 г/м крейдованому папері. Обкладинка — тверда
                ламінована палітурка з індивідуальним дизайном. Це найбільш
                популярний у світі формат фотокниг. Основною рисою фотокниги є
                оперативність виготовлення, унікальність її зовнішнього вигляду
                і доступність в ціні. Для кожної фотокниги Ви можете створити
                свій, унікальний дизайн обкладинки, форзаців і сторінок.
              </p>
            </div>
          </div>
          ...
          <div className="d-none d-md-block">
            <div className="row m-3 p-2">
              <div className="col-sm-12 col-md-5 px-3">
                ...
                <p>
                  Для друку фотокниг ми використовуємо крейдований папір
                  щільністю 170 г/м (до прикладу журнали друкують на папері 80
                  г/м). Також, Ви можете замовити фотокнигу на premium папері,
                  який більш яскравий і біліший.
                </p>
              </div>
              <div className="col-sm-12 col-md-7">
                <Zoom {...zoomInProperties}>
          ...
          <div className="row m-3 p-2">
            ...
            <div className="col-sm-12 col-md-5 px-3">
              ...
              <p>
                ...
                схильні до механічних пошкоджень і вологи. Форзаци фотокниги не
                ламінують. При підготовці макету фотокниги під ламінування,
                рекомендуємо врахувати, що кольори будуть насиченіші і внести в
                макет відповідні коригування кольору.
              </p>
            </div>
          </div>
          ...
          <div className="d-none d-md-block">
            <div className="row m-3 p-2">
              <div className="col-sm-12 col-md-5 px-3">
                ...
                <p>
                  Це аркуш паперу призначений для фіксації блоку в корінці.
                  Форзац складається з 2 окремих паперових заготовок на початку
                  та в кінці книги, які одночасно з'єднуються в корінцевій
                  частині та приклеюються до зворотньої сторони обкладинки. На
                  форзаци також можна нанести зображення.
                </p>
              </div>
              <div className="col-sm-12 col-md-7">
                <Zoom {...zoomInProperties}>
