...
import Fancybox19x19Planshet from "../MakeFancyBox/Fancybox19x19Planshet";
...
export function ShowClaim19x19Photo() {
  return (
    <>
      <h4 className="m-3 text-center text-danger">Розміри 19x19</h4>
      <div className="row">
...
export function ShowClaim19x19Uni() {
  return (
    <>
      <h4 className="m-3 text-center text-danger">Розміри 19x19</h4>
      <div className="row">
...
export function ShowClaim19x19Planshet() {
  return (
    <>
      <h4 className="m-3 text-center text-danger">Розміри 19x19</h4>
      <div className="row">
