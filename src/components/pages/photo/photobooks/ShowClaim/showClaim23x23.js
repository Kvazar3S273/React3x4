...
import Fancybox23x23Planshet from "../MakeFancyBox/Fancybox23x23Planshet";
...
export function ShowClaim23x23Photo() {
  return (
    <>
      <h4 className="m-3 text-center text-danger">Розміри 23x23</h4>
      <div className="row">
...
export function ShowClaim23x23Uni() {
  return (
    <>
      <h4 className="m-3 text-center text-danger">Розміри 23x23</h4>
      <div className="row">
...
export function ShowClaim23x23Planshet() {
  return (
    <>
      <h4 className="m-3 text-center text-danger">Розміри 23x23</h4>
      <div className="row">
          ...
          <table class="table table-striped">
            <tbody>
              ...
              <tr>
                ...
                <td>519 x 274 мм (6130 x 3236 пікселів)</td>
              </tr>
              <tr>
                <th scope="row" className="text-success">
                  Файл розвороту
                </th>
                <td>471 x 244 мм (5563 x 2882 пікселів)</td>
              </tr>
            </tbody>
          </table>
        </div>
        <div className="col-md-4">
          <Fancybox23x23Planshet />
        </div>
      </div>
    </>
  );
